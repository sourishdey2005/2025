    ...
    <section className="py-40 px-6 text-center bg-transparent relative z-10">
      <div className="max-w-2xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className="text-xs uppercase tracking-[0.4em] text-pink-400 font-bold mb-8 block">Our Future</span>
          ...
          <div className="flex flex-col items-center gap-6">
            <span className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Continue the journey</span>
            <motion.button
            ...
            >
              <span className="font-bold text-lg uppercase tracking-wider">Forever Starts Here</span>
              <motion.div
